...
import { ProgressTracker, type AgentProgress } from "../../src/runtime/progress-tracker.ts";
...
test("ProgressTracker counts tool calls", () => {
  ...
  // Add events
  events.push(
    { type: "tool_execution_start", toolName: "read", toolCallId: "1", args: {} } as any,
    { type: "tool_execution_end", toolName: "read", toolCallId: "1", isError: false, result: "ok" } as any,
    { type: "tool_execution_start", toolName: "bash", toolCallId: "2", args: {} } as any,
    { type: "tool_execution_end", toolName: "bash", toolCallId: "2", isError: false, result: "ok" } as any,
  );
...
test("ProgressTracker tracks errors", () => {
  ...
  const events: any[] = [
    ...
    { type: "tool_execution_end", toolName: "bash", toolCallId: "1", isError: true, result: "Exit code 1" },
  ];
